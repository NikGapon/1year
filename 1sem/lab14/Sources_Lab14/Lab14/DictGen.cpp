...
//	//createDictionary(dict, "D:\\temp\\Files\\Lab14\\Alice.txt");
//	createDictionary(dict, "Alice.txt");
//
//	t1 = clock();
//	printf("t1 = %f sec \n", t1 / (float)CLOCKS_PER_SEC);
//
//	//shuffle(dict);
//	//saveDictionary(dict, "D:\\temp\\Files\\Lab14\\dict1.txt");
//
//	saveDictionary(dict, "dict32.txt");
//	destroy(dict);
//
//	t2 = clock();
//	printf("t2 = %f sec \n",
