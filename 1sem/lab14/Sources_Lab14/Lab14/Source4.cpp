...
//int sort(char * word)
//{
//	unsigned long sort_value = 0;
//	int i = 0;
//	while (word[i] != '\0') {
//		sort_value = 31 * sort_value + ((unsigned)(word[i]));
//		i++;
//	}
//	return sort_value % MAX_sort;
//}
//
//void addWord(struct Dictionary * dict, char * word)
//{
...
//
//	int sort_value = sort(word);
//
//	newNode->next = dict->first[sort_value];
//	newNode->word = (char *)calloc(strlen(word) + 1,
//		sizeof(char));
//	strcpy(newNode->word, word);
//
//	dict->cnt_words++;
//	dict->first[sort_value] = newNode;
//}
//
//void destroy(struct Dictionary * dict) {
//
...
//
//
//	struct Node * ptr = dict->first[sort_value];
//	while (ptr != NULL) {
